        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    changed_by_platform_user_id = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    default_department_id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_task_templates_branches_branch_id",
                        column: x => x.branch_id,
                        principalTable: "branches",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_task_templates_users_default_assignee_user_id",
                        column: x => x.default_assignee_user_id,
                        principalTable: "users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    due_time = table.Column<TimeOnly>(type: "time without time zone", nullable: false),
                    is_active = table.Column<bool>(type: "boolean", nullable: false),
                    created_by = table.Column<Guid>(type: "uuid", nullable: false),
                    created_at = table.Column<DateTimeOffset>(type: "timestamptz", nullable: false),
                    updated_at = table.Column<DateTimeOffset>(type: "timestamptz", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_task_schedules_dates", "\"end_date\" IS NULL OR \"end_date\" >= \"start_date\"");
                    table.CheckConstraint("ck_task_schedules_interval", "\"recurrence_interval\" > 0");
                    table.CheckConstraint("ck_task_schedules_month_day", "\"month_day\" IS NULL OR (\"month_day\" >= 1 AND \"month_day\" <= 31)");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_task_schedules_users_assignee_user_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_task_schedules_assignee_user_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_task_schedules_organization_id_start_date",
                table: "task_schedules",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_task_status_history_organization_id",
                table: "task_status_history",
                column: "organization_id");

            migrationBuilder.CreateIndex(
                name: "IX_task_status_history_task_id_created_at",
                table: "task_status_history",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_task_templates_branch_id",
                table: "task_templates",
                column: "branch_id");

            migrationBuilder.CreateIndex(
                name: "IX_task_templates_default_assignee_user_id",
                table: "task_templates",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tasks_task_schedule_id_occurrence_date_scheduled_start_at",
                table: "tasks",
